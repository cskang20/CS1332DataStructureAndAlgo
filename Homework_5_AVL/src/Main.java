...
//        } else if (balance < -1 && data.compareTo(current.getRight().getData()) > 0) {
//            return rotateLeft(current);
//
//            //current < data (Left Right Case)
//        } else if (balance > 1 && data.compareTo(current.getLeft().getData()) > 0) {
...
//     */
//    private List<T> preorderHelper(AVLNode<T> current, List<T> set) {
//        if (current == null) {
//            return set;
//        }
...
//
//        if (!contains(data)) {
//            throw new java.util.NoSuchElementException("No matching data with given data found.");
//        } else {
...
//     * @return the data choosen if exist
//     */
