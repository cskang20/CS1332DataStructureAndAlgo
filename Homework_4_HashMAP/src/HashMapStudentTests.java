...
/**
 * A set of basic tests to test your HashMap implementation.
 *
...
public class HashMapStudentTests {
    ...
    public void testInitialization() {
        assertEquals(13, HashMap.INITIAL_CAPACITY);
    ...
    public void testPut() {
        // [(0, A), (1, B), (2, C), (3, D), (4, E), _, _, _, _, _, _, _, _] ->
        // [(0, A), (1, B), (2, C), (3, D), (4, E), _, (6, F), _, _, _, _, _, _]
    ...
    public void testRemove() {
        // [(0, A), (1, B), (2, C), (3, D), (4, E), _, _, _, _, _, _, _, _] ->
        // [(0, A), (1, B), (2, C), X(3, D), (4, E), _, _, _, _, _, _, _, _]
